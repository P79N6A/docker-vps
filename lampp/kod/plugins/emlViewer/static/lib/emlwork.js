...
var mhtParseMore = function(mailObject,mailparser){
    ...
    var parseCharset = function(mailObject){
        ...
        if(mailObject.html.indexOf('"urn:schemas-microsoft-com:office:office"') != -1){
            mailObject.html = mailparser._convertStringToUTF8(mailObject.html);
        }
    }
    parseCharset(mailObject);
    parseImage(mailObject);
    console.log(1113,mailObject,mailObject.html)
};
            ...
            for (var i = 0; i <= mailObject.attachments.length - 1; i++) {
                ...
                if (g_mht && ishtml) {
                    ...
                    if (a.contentDisposition == "attachment") {
                        ...
                        attachdtl.innerHTML = '<div class="icon"><i class="x-item-file x-' + ext + '"></i></div><div class="attachinfo"><span title="' + filename + '">' + filename + '</span><br><span>' + tmpsize + '</span></div>';
