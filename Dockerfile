...
EXPOSE		1920-1926 6880-6888
#tcp：1920-sss, 1921-ftp, 1922-ssh,1923-kod,1925-mlnet,1926-deluge
#tcp/udp：6885-6888-deluge, 6880-ed/tcp, 6884-ed/udp, 6881,6882-bt, 6883-dht/udp

RUN			/usr/bin/apt-get -y update; \
				/usr/bin/apt-get -y upgrade; \
				/usr/bin/apt-get -y install apt-utils net-tools nano tzdata ssh deluge-web deluged mldonkey-server golang-cfssl libsodium23 shadowsocks; \
